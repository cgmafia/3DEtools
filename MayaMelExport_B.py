...
def add_pipeline_parms(mel_path, mel):
    with open(mel_path, 'a') as f:
        f.write(mel)
...
if __name__ == '__main__':
    melscript_path = main()
    print('--> melscript_path: ', melscript_path)

    mel = get_pipeline_parms()

    add_pipeline_parms(melscript_path, mel)

    delens_node = NukeRadialStandardLensExport.main(melscript_path)
    print('--> delens_node: ', delens_node)

    do_maya_import(melscript_path)
    print('--> Done...')
