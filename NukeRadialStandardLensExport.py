"""
3DE lens exporter module:
export_nuke_LD_3DE4_Lens_Distortion_Node.py

updted to be called from MayaMelExport module.
saves lens automatically when exporting mel.
Puts nuke node next to mel script

author: github/danielforgacs
"""
